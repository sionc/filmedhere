...
describe LocationsController do
  ...
  let(:valid_attributes) { { "raw_address" => "MyString" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved location as @location" do
        ...
        post :create, {:location => { "raw_address" => "invalid value" }}, valid_session
        expect(assigns(:location)).to be_a_new(Location)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested location" do
        ...
        expect_any_instance_of(Location).to receive(:update).with({ "raw_address" => "MyString" })
        put :update, {:id => location.to_param, :location => { "raw_address" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the location as @location" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Location.any_instance.stub(:save).and_return(false)
        put :update, {:id => location.to_param, :location => { "raw_address" => "invalid value" }}, valid_session
        expect(assigns(:location)).to eq(location)
      end
